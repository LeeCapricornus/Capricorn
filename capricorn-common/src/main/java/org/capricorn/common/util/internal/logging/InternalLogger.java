...
public interface InternalLogger {
    ...
    /**
     * Return the name this {@link InternalLogger} instance
     *
    ...
    /**
     * <p>This form avoids superfluous string concatenation when the logger is disabled for the TRACE level.
     * However,this variant incurs the hidden (and relatively small) cost of creating an {@code Object[]} before invoking the method,
     ...
     * <p>This form avoids superfluous object creation when the logger is disabled for DEBUG level</p>
     *
     * @param format
     * @param arg
     */
    ...
    /**
     * <p>This form avoids superfluous string concatenation when the logger is disabled for the DEBUG level.
     * However,this variant incurs the hidden (and relatively small) cost of creating an {@code Object[]} before invoking the method,
     * even if this logger is disabled for TRACE.The variants taking {@link #debug(String,Object) one} and
    ...
    /**
     * <p>This form avoids superfluous string concatenation when the logger is disabled for the INFO level.
     * However,this variant incurs the hidden (and relatively small) cost of creating an {@code Object[]} before invoking the method,
     * even if this logger is disabled for TRACE.The variants taking {@link #info(String,Object) one} and
    ...
    /**
     * Log a message at WARN level according to the specified format and argument.
     *
     * @param format
     * @param arg
     */
